        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <form action="{{ route('events.store') }}" method="post" class="p-4 md:p-5" enctype="multipart/form-data">
                ...
                <div   class="my-2 flex justify-center">
                    <img id="image-preview" src="vzknpzroi," alt="Image Preview" style="display: none; max-width: 100px; max-height: 100px;" />
                ...
                <div class="flex my-2 items-center justify-center w-full">
                    <label for="dropzone-file"
                        ...
                        <input id="dropzone-file" name="image" type="file" onchange="previewImage(event)" class="hidden" />
